            ...
            'auth' => [
                'user' => $user
                    ? [
                        ...
                        'role' => $user->role,
                        'avatar' => $user->avatar_thumbnail_url,
                        'avatar_thumbnail' => $user->avatar_thumbnail_url,
                        'avatar_original' => $user->avatar_original_url,
                        'avatarMedia' => $user->avatarMedia
                            ? [
                                'id' => $user->avatarMedia->id,
                                'name' => $user->avatarMedia->name,
                                'path' => $user->avatarMedia->path,
                                'url' => $user->avatarMedia->getOriginalUrl(),
                                'original_url' => $user->avatarMedia->getOriginalUrl(),
                                'thumbnail_url' => $user->avatarMedia->getThumbnailUrl(),
